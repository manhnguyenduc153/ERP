    ...
    public partial class InitMySqlSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Category__19093A2BE2D6DC6E", x => x.CategoryID);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Customer__A4AE64B89CFD12C8", x => x.CustomerID);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Supplier__4BE666947DC7D6D2", x => x.SupplierID);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Warehous__2608AFD9AED5EB32", x => x.WarehouseID);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Product__B40CC6EDC3347528", x => x.ProductID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__SalesOrd__B14003C24D78F2EB", x => x.SalesOrderID);
                    table.ForeignKey(
                        name: "FK__SalesOrde__Custo__5812160E",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Purchase__036BAC44B17A959C", x => x.PurchaseOrderID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionType = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TransactionDate = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "(CURRENT_TIMESTAMP)")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__StockTra__55433A4B1FD05409", x => x.TransactionID);
                    table.ForeignKey(
                        name: "FK__StockTran__Produ__5165187F",
                        column: x => x.ProductID,
                        principalTable: "Product",
                        principalColumn: "ProductID");
                    table.ForeignKey(
                        name: "FK__StockTran__Wareh__52593CB8",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__SalesOrd__135C314D9D66FA8B", x => x.DetailID);
                    table.ForeignKey(
                        name: "FK__SalesOrde__Produ__5BE2A6F2",
                        column: x => x.ProductID,
                        principalTable: "Product",
                        principalColumn: "ProductID");
                    table.ForeignKey(
                        name: "FK__SalesOrde__Sales__5AEE82B9",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Purchase__135C314D4CA8D87F", x => x.DetailID);
                    table.ForeignKey(
                        name: "FK__PurchaseO__Produ__656C112C",
                        column: x => x.ProductID,
                        principalTable: "Product",
                        principalColumn: "ProductID");
                    table.ForeignKey(
                        name: "FK__PurchaseO__Purch__6477ECF3",
